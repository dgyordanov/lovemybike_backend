...
//    }
    ...
    public @ResponseBody String postOffer(
            ...
            @RequestParam("description") String street,
            @RequestParam("description") String number,
            @RequestParam("description") String postcode,
            @RequestParam("description") String city,
